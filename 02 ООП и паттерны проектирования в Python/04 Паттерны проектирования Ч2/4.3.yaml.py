...
def constructor_easy_level_class(loader, node):
    value = loader.construct_mapping(node)
    return EasyLevel()


def constructor_medium_level_class(loader, node):
    value = loader.construct_mapping(node)
    return MediumLevel()


def constructor_hard_level_class(loader, node):
    value = loader.construct_mapping(node)
    return HardLevel()

yaml.add_constructor('!easy_level', constructor_easy_level_class)
yaml.add_constructor('!medium_level', constructor_medium_level_class)
yaml.add_constructor('!hard_level', constructor_hard_level_class)
